...
This script adds the address to the billing details when the Kajabi checkout form submits data to Stripe.
...
- Set and forget. No configuration is required.
- Zero dependencies.
...
In this example, the offer URL `www.yourdomain.com/offers/DcTeKx7o/checkout`, the `DcTeKx7o` is the offer slug. You may combine more slugs using a comma.
